    ...
    describe('doExport', function () {
        ...
        it('should try to export all the correct tables (without excluded)', function (done) {
            ...
            exporter.doExport().then(function (exportData) {
                ...
                knexMock.getCall(5).args[0].should.eql('parents_users');
                ...
                knexMock.getCall(13).args[0].should.eql('rooms');
                knexMock.getCall(14).args[0].should.eql('apps');
                knexMock.getCall(15).args[0].should.eql('app_settings');
                knexMock.getCall(16).args[0].should.eql('app_fields');
        ...
        it('should try to export all the correct tables with extra tables', function (done) {
            ...
            exporter.doExport({include: ['clients', 'client_trusted_domains']}).then(function (exportData) {
                ...
                knexMock.getCall(15).args[0].should.eql('app_settings');
                knexMock.getCall(16).args[0].should.eql('app_fields');
                knexMock.getCall(17).args[0].should.eql('clients');
                knexMock.getCall(18).args[0].should.eql('client_trusted_domains');
